<script lang="ts">
    ...
    import { gameData, socket } from "$lib/scripts/shared/data";
    import { playerCount, playersWriteable as playersStore } from "$lib/scripts/host/data";
    import animejs from "animejs";
    import { info } from "@lanred/basic-logger";
    import until from "$lib/scripts/shared/functions/until";
